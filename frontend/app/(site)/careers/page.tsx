    ...
    <>
      ...
      <section className="py-12 px-4 bg-slate-50 pb-24">
        <div className="max-w-7xl mx-auto">
          <div className="rounded-none bg-white px-10 py-16 text-center shadow-lg border border-slate-200/80">
            <h2 className="text-3xl md:text-4xl font-bold text-construction-navy mb-4 font-display uppercase tracking-tight">
