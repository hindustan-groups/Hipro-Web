    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="relative pt-32 pb-16 lg:pt-40 lg:pb-24 overflow-hidden bg-black">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 text-center">
          <Link href="/services" className="inline-flex items-center text-slate-300 hover:text-white mb-6 transition-colors text-xs font-semibold uppercase tracking-wider group bg-white/10 px-4 py-2 rounded-full border border-white/20">
            <Icons.ArrowLeft className="w-4 h-4 mr-2 group-hover:-translate-x-1 transition-transform" />
            Back to Capabilities
          </Link>
          
          <div className="flex justify-center mb-6">
            <div className="w-12 h-12 bg-construction-red flex items-center justify-center text-white shadow-xl rounded-full">
              <Icon className="w-6 h-6" />
            </div>
          </div>
          
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 font-display uppercase tracking-tight max-w-4xl mx-auto">
            {service.title}
          </h1>
      ...
      <section className="bg-construction-navy py-20 border-t-4 border-construction-red">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6 font-display uppercase tracking-tight">
