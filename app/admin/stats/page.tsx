    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={fetchStats}
          disabled={loading}
          className="flex items-center gap-2 bg-white border border-slate-200 text-slate-600 px-3 py-1.5 rounded-none text-xs font-medium disabled:opacity-50 hover:bg-slate-50 hover:text-slate-900 transition-colors shadow-sm"
        >
