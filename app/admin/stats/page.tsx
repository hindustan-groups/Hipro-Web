    ...
    <div className="space-y-6">
      ...
      {loading ? (
        <div className="grid md:grid-cols-2 gap-4 animate-pulse">
          {[...Array(6)].map((_, i) => (
            <div key={i} className="h-32 bg-white border border-slate-200 shadow-sm rounded-none" />
          ))}
        </div>
      ) : (
        <div className="grid md:grid-cols-2 gap-4">
          {stats.map((s) => (
            <div key={s.id} className="bg-white border border-slate-200 shadow-sm hover:shadow-md rounded-none p-5 transition-shadow">
              <div className="flex items-center justify-between mb-4 pb-3 border-b border-slate-100">
                <div className="flex items-center gap-2.5">
                  <div className="w-8 h-8 rounded-none bg-red-50 border border-red-100 flex items-center justify-center text-construction-red">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-200 text-slate-900 rounded-none px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-construction-navy/20 focus:border-construction-navy transition-all font-bold"
                  />
                </div>
                <div>
                  <label className="text-slate-500 text-[10px] uppercase tracking-widest font-bold block mb-1">
              ...
              <button
                ...
                className="mt-5 w-full flex items-center justify-center gap-2 bg-construction-navy hover:bg-blue-800 disabled:opacity-50 text-white text-xs font-bold py-2.5 rounded-none transition-colors shadow-md shadow-blue-900/20"
              >
                {saving === s.id ? (
