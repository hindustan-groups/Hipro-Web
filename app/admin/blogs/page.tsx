                ...
                blogs.map((b) => (
                  <tr key={b.id} className={`transition-colors ${b.active === false ? "opacity-50 bg-slate-50/50" : "hover:bg-slate-50"}`}>
                    <td className="px-5 py-4">
                      {b.image ? (
                        <img src={b.image} alt={b.title} className="w-10 h-10 object-cover rounded-none-none" />
                      ) : (
                        <div className="w-10 h-10 bg-slate-200 rounded-none-none" />
                      )}
                    </td>
                    ...
                    <td className="px-5 py-4 text-slate-600"><span className="px-2 py-1 bg-slate-100 rounded-none-none text-xs">{b.category}</span></td>
                    <td className="px-5 py-4 text-slate-600 whitespace-nowrap">{b.date}</td>
                    <td className="px-5 py-4">
                      <div className="flex justify-center">
                        <button onClick={() => toggleActive(b)} className={`w-8 h-8 rounded-none-none flex items-center justify-center transition-colors ${b.active !== false ? "bg-green-100 text-green-700 border border-green-200" : "bg-slate-50 border border-slate-200 text-slate-400 hover:text-slate-700"}`}>
