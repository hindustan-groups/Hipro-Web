    ...
    <section id="section-services" className="py-24 bg-white relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 text-center">
          <Link 
            href="/services" 
            className="inline-flex items-center justify-center gap-3 bg-white border border-slate-300 text-black font-bold px-10 py-4 rounded-xl text-[15px] hover:bg-black hover:border-black hover:text-white transition-all shadow-sm"
          >
            View All Services
          </Link>
        </div>
